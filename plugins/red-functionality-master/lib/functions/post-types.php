...
function product_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Products', 'Post Type General Name', 'Inhabitant' ),
		'singular_name'         => _x( 'Product', 'Post Type Singular Name', 'Inhabitant' ),
	...
	$args = array(
		...
		'description'           => __( 'This is a custom type post for product', 'text_domain' ),
		'labels'                => $labels,
